...
const Icon2 = color => {
	return (
		<svg
			...
			<g mask='url(#mask0_1:66)'>
				<rect
					width='24'
					height='24'
					fill='url(#paint0_linear_1:66)'
				/>
			</g>
			<g filter='url(#filter0_dd_1:66)'>
				<circle cx='8' cy='12' r='1' fill='white' />
			</g>
			<g filter='url(#filter1_dd_1:66)'>
				<circle cx='12' cy='12' r='1' fill='white' />
			</g>
			<g filter='url(#filter2_dd_1:66)'>
			...
			<defs>
				<filter
					...
					<feBlend
						...
						result='effect1_dropShadow_1:66'
					/>
					<feColorMatrix
						in='SourceAlpha'
						type='matrix'
					...
					<feBlend
						mode='normal'
						in2='effect1_dropShadow_1:66'
						result='effect2_dropShadow_1:66'
					/>
					<feBlend
						mode='normal'
						in='SourceGraphic'
						in2='effect2_dropShadow_1:66'
						result='shape'
					/>
				</filter>
				<filter
